...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:saadshamim@localhost:5432/todoapp'
...
def get_list_todos(list_id):
    ...
    return render_template('index_7.html', todos=todos, lists=lists, active_list=active_list)
